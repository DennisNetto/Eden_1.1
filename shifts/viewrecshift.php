 ...
 *  Description: Allows coordinators to select staff, clients, or departments to view recurring shifts for
...
<head>
	...
	<link href="../css/table.css" rel="stylesheet" type="text/css">
				...
				function setSelect(selection) {
					...
					xmlhttp.open("GET","viewrecshift.php?change="+selection,true);
					xmlhttp.send();
				}
...
';
			...
			//display the form
			echo "<form class='form-con' action='viewrecshifts.php' method='post'>";
			...
			if(isset($_REQUEST['p']))
				echo "<div class='alert alert-success'>Recurring shifts updated successfully.</div>";

			echo "<h5>View shifts for:</h5><br />
					...
					<select class='fanc' id='viewBy' onchange='setSelect(this.value)' name='type'>
						...
						<input type='submit' class='btn btn-primary' name='view' value='View Shifts' /><br /><br />
						<a class='btn btn-info'; href='viewallrecshift.php'>View all shifts</a><br /><br />
